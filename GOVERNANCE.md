...
`jooservices/laravel-notifications` is an owner-driven project (benevolent-leader style). JOOservices maintains the package; the project owner holds final decision authority.
